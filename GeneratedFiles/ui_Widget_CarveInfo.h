...
public:
    ...
    void setupUi(QWidget *Widget_CarveInfo)
    {
        ...
        Widget_CarveInfo->resize(400, 300);
        ...
        horizontalLayout_12->addWidget(pushButton_setToCamera);
        ...
        gridLayout_4 = new QGridLayout(widget_GrayTest);
        ...
        gridLayout_2->addWidget(label_Sharpness, 0, 2, 1, 1);
        ...
        gridLayout_2->addWidget(label_AverageGray, 0, 0, 1, 1);
        ...
        gridLayout_2->addWidget(lineEdit_gray, 0, 1, 1, 1);
        ...
        gridLayout_2->addWidget(lineEdit_sharpness, 0, 3, 1, 1);
        ...
        qwtPlot_sharpness->setMaximumSize(QSize(16777215, 150));

        gridLayout_4->addWidget(qwtPlot_sharpness, 1, 0, 1, 1);
        ...
        pushButton_setToCamera_2 = new QPushButton(widget_camera);
        ...
        horizontalLayout_3->addWidget(pushButton_setToCamera_2);

        pushButton_grey = new QPushButton(widget_camera);
        pushButton_grey->setObjectName(QString::fromUtf8("pushButton_grey"));
        pushButton_grey->setMinimumSize(QSize(80, 40));

        horizontalLayout_3->addWidget(pushButton_grey);
    ...
    {
        Widget_CarveInfo->setWindowTitle(QApplication::translate("Widget_CarveInfo", "Form", 0, QApplication::UnicodeUTF8));
        ...
        pushButton_setToCamera_2->setText(QApplication::translate("Widget_CarveInfo", "SetToCamera", 0, QApplication::UnicodeUTF8));
